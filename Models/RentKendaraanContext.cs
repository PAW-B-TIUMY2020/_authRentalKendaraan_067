...
{
    public partial class RentKendaraanContext : IdentityDbContext<IdentityUser>
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
               ...
               .Build();
                ...
                optionsBuilder.UseSqlServer("Server=DESKTOP-SU3D3TD;Database=RentKendaraan;Trusted_Connection=True;");
            }
        }
